...
Exemplos:
| email | mensagem |
| "testeteste.com" | "Digite um endereço de e-mail. Ex: abc@xyz.com" |
| "teste@teste" |"E-mail inválido, tente novamente." |
| "teste" | "Digite um endereço de e-mail válido." |
| "teste@teste.com.br" | "Este e-mail não está cadastrado na plataforma." |
